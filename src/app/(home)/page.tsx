...
export default function Page({
  ...
  return (
    <main className="flex-1 flex h-full flex-col items-center py-8 pb-20 md:p-24 sm:py-16 bg-[--primary_bg] overflow-y-scroll">
      <div className="w-full max-w-3xl px-4">
        <div className="my-8 flex justify-between">
          ...
          <div className="flex flex-wrap items-center">
            <StatusDropdown searchParamsList={status} />
